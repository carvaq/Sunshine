package cvv.udacity.sunshine.sync;
...
import cvv.udacity.sunshine.DetailActivity;
import cvv.udacity.sunshine.R;
import cvv.udacity.sunshine.SecretStuff;
import cvv.udacity.sunshine.Utility;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            locationValues.put(cvv.udacity.sunshine.data.WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING, locationSetting);
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        if(forecastJson.has(OWM_MESSAGE_CODE)) {
            ...
            if (code == HttpURLConnection.HTTP_NOT_FOUND) {
                saveLocationStatus(LOCATION_STATUS_INVALID);
        ...
        if (cVVector.size() > 0) {
            ...
            getContext().getContentResolver().delete(WeatherContract.WeatherEntry.CONTENT_URI,
                    ...
                    new String[]{
                            String.valueOf(Long.toString(dayTime.setJulianDay(julianStartDay - 1)))
                    });
    ...
    private void saveLocationStatus(@LocationStatus int locationStatus) {
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(getContext());
        sharedPreferences.edit()
                .putInt(getContext()
                        .getString(R.string.loc_status), locationStatus).commit();
    }
}